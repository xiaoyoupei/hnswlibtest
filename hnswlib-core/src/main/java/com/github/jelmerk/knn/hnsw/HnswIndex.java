...
public class HnswIndex<TId, TVector, TItem extends Item<TId, TVector>, TDistance>
    ...
    private <TItem> Node<TItem> readNode(ObjectInputStream ois,
    ...
    private <TItem> AtomicReferenceArray<Node<TItem>> readNodesArray(ObjectInputStream ois,
                                                                     ObjectSerializer<TItem> itemSerializer,
                                                                     int maxM0,
                                                                     int maxM)
    ...
    private <TId> MutableObjectIntMap<TId> readMutableObjectIntMap(ObjectInputStream ois,
    ...
    private <TId> MutableObjectLongMap<TId> readMutableObjectLongMap(ObjectInputStream ois,
                                                                     ObjectSerializer<TId> itemIdSerializer)
            throws IOException, ClassNotFoundException {
